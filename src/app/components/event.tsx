        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="relative group overflow-hidden rounded-lg">
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-black p-6">
              <div className="text-yellow-400 mb-2">AUG 29 | 6:30am</div>
              <div className="flex items-center justify-between">
                ...
                <Link
                  href="/events"
                  className="bg-yellow-400 px-4 py-2 rounded-full text-black text-sm font-medium hover:bg-yellow-300 transition-colors"
                >
                  Learn More
                </Link>
              </div>
